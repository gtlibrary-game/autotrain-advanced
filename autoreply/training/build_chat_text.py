    ...
    for file_path in file_paths:
        with open(file_path, 'r', encoding='utf-8', errors='replace') as file:
            ...
            if generated_text != "" and sentiment != "" and pacing != "" and plotting != "":
                extracted_data.append(("### Human: Reduce Narrative (sentiment, pacing, plotting): " + generated_text + "### " +
                                       f"Assistant: Reduced Narrative: {sentiment}, {pacing}, {plotting}###", ""))            
...
with open(csv_path, mode='w', newline='', encoding='utf-8') as file:
    ...
    writer.writerow(["text", "unused"])  # Writing header
